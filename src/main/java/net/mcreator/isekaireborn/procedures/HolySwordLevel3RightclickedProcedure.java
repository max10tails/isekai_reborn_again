...
public class HolySwordLevel3RightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		double precision2 = 0;
		double speed2 = 0;
		if (cooldown22 == 0 && cooldown22 >= 10) {
			cooldown22 = cooldown22 - 10;
		...
		if (cooldown22 == 1 && cooldown22 >= 25) {
			cooldown22 = cooldown22 - 25;
			if (entity instanceof LivingEntity _entity)
				_entity.swing(InteractionHand.MAIN_HAND, true);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
			...
			for (int index1 = 0; index1 < (int) (entity.getPersistentData().getDouble("range") * precision); index1++) {
				...
				IsekaiRebornMod.queueServerWork((int) delay, () -> {
					...
					entity.getPersistentData().putDouble("sz", (entity.getPersistentData().getDouble("sz") + entity.getPersistentData().getDouble("z+") * (-0.2)));
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.SOUL_FIRE_FLAME, (entity.getPersistentData().getDouble("sx")), (entity.getPersistentData().getDouble("sy")), (entity.getPersistentData().getDouble("sz")),
		...
		if (cooldown22 == 2 && cooldown22 >= 30) {
			cooldown22 = cooldown22 - 30;
			if (entity instanceof LivingEntity _entity)
				_entity.swing(InteractionHand.MAIN_HAND, true);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
			...
			for (int index2 = 0; index2 < (int) (entity.getPersistentData().getDouble("range") * precision); index2++) {
				...
				IsekaiRebornMod.queueServerWork((int) delay, () -> {
								...
								(entity.getPersistentData().getDouble("width")), 0);
					{
						...
						for (Entity entityiterator : _entfound) {
							if (!(entity == entityiterator || entityiterator instanceof ExperienceOrb || entityiterator instanceof ItemEntity)) {
								entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.GENERIC)), 60);
								if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) == 0) {
									entity.getPersistentData().putDouble("kill", 1);
								}
							}
		...
		if (cooldown22 == 2 && cooldown22 >= 30) {
			...
			delay2 = 0;
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(itemstack.getItem(), (int) (cooldown22 * 20));
						...
						for (Entity entityiterator : _entfound) {
							if (!(entity == entityiterator || entityiterator instanceof ExperienceOrb || entityiterator instanceof ItemEntity)) {
								...
								if (world instanceof Level _level && !_level.isClientSide())
									_level.explode(null, (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 6, Level.ExplosionInteraction.NONE);
								if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) == 0) {
									entity.getPersistentData().putDouble("kill", 1);
								}
							}
		...
		if (cooldown22 == 3 && cooldown22 >= 45) {
			cooldown22 = cooldown22 - 45;
			if (entity instanceof LivingEntity _entity)
				_entity.swing(InteractionHand.MAIN_HAND, true);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
			...
			for (int index4 = 0; index4 < (int) (entity.getPersistentData().getDouble("range") * precision); index4++) {
				delay = delay + speed / precision;
				IsekaiRebornMod.queueServerWork((int) delay, () -> {
					...
					entity.getPersistentData().putDouble("sz", (entity.getPersistentData().getDouble("sz") + entity.getPersistentData().getDouble("z+") * (-0.2)));
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.SOUL_FIRE_FLAME, (entity.getPersistentData().getDouble("sx") + Math.sin(entity.getPersistentData().getDouble("h")) * (entity.getDirection()).getStepZ()),
								...
								(int) (10 * Math.ceil(entity.getPersistentData().getDouble("width") + entity.getPersistentData().getDouble("size"))), (entity.getPersistentData().getDouble("width")), (entity.getPersistentData().getDouble("size")),
								(entity.getPersistentData().getDouble("width")), 0);
					if (world instanceof ServerLevel _level)
								...
								(entity.getPersistentData().getDouble("width")), 0);
					{
						...
						for (Entity entityiterator : _entfound) {
							if (!(entity == entityiterator || entityiterator instanceof ExperienceOrb || entityiterator instanceof ItemEntity)) {
								entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.GENERIC)), 80);
								if (world instanceof Level _level && !_level.isClientSide())
									_level.explode(null, (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 4, Level.ExplosionInteraction.TNT);
								if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) == 0) {
									entity.getPersistentData().putDouble("kill", 1);
								}
							}
