...
public class HolySwordFullPowerRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (precision == 3 && precision >= 45) {
			precision = precision - 45;
			if (entity instanceof LivingEntity _entity)
				_entity.swing(InteractionHand.MAIN_HAND, true);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
						...
						for (Entity entityiterator : _entfound) {
							if (!(entity == entityiterator || entityiterator instanceof ExperienceOrb || entityiterator instanceof ItemEntity)) {
								...
								if (world instanceof Level _level && !_level.isClientSide())
									_level.explode(null, (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 5, Level.ExplosionInteraction.NONE);
								if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) == 0) {
									entity.getPersistentData().putDouble("kill", 1);
								}
							}
		...
		if ((precision == 4) == (precision >= 60)) {
			...
			entity.getPersistentData().putDouble("size", (size / 10));
			entity.getPersistentData().putDouble("width", (width / 10));
			for (int index5 = 0; index5 < (int) (entity.getPersistentData().getDouble("range") * precision); index5++) {
				delay = delay + speed / precision;
				IsekaiRebornMod.queueServerWork((int) delay, () -> {
					entity.getPersistentData().putDouble("sx", (entity.getPersistentData().getDouble("sx") + entity.getPersistentData().getDouble("x+") * (-0.2)));
					entity.getPersistentData().putDouble("sy", (entity.getPersistentData().getDouble("sy") + entity.getPersistentData().getDouble("y+") * (-0.2)));
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.SOUL_FIRE_FLAME, (entity.getPersistentData().getDouble("sx")), (entity.getPersistentData().getDouble("sy")), (entity.getPersistentData().getDouble("sz")),
								(int) (8 * Math.ceil(entity.getPersistentData().getDouble("width") + entity.getPersistentData().getDouble("size"))), (entity.getPersistentData().getDouble("width")), (entity.getPersistentData().getDouble("size")),
								(entity.getPersistentData().getDouble("width")), 0);
					if (world instanceof ServerLevel _level)
