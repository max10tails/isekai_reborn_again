 ...
 *
 */
package net.mcreator.isekaireborn;
...
@Mod("isekai_reborn")
public class IsekaiRebornMod {
	public static final Logger LOGGER = LogManager.getLogger(IsekaiRebornMod.class);
	public static final String MODID = "isekai_reborn";
